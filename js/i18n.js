...
const pageI18n = {
  portfolio: {
    en: {
      work_h1: "Work",
      work_sub: "Real projects built for local businesses—focused on clarity, branding, and results.",
      work_header_btn: "Start Your Project",
      featured_tag: "Featured Project",
      rcr_intro: "Multi-page website for a local barbershop brand with booking integration, service presentation, and contact-focused structure.",
      ...
      other_title: "Other Solutions",
      other_sub: "More business-focused website solutions available.",
      other_1t: "Express Website 72H",
      other_1d: "Fast-launch websites for businesses that need to get online quickly.",
      other_1b: "View Service",
      other_2t: "Business Website Framework",
      other_2d: "A flexible website structure adaptable to different local business industries.",
      other_2b: "Request Info",
    ...
    fr: {
      ...
      work_sub: "Des projets réels créés pour des entreprises locales — avec clarté, branding et résultats.",
      work_header_btn: "Démarrer votre projet",
      featured_tag: "Projet en vedette",
      rcr_intro: "Site multi-page pour une marque de barbershop locale avec intégration de réservation, présentation des services et structure orientée contact.",
      ...
      other_title: "Autres solutions",
      other_sub: "D’autres solutions web orientées business sont disponibles.",
      other_1t: "Site Express 72H",
      other_1d: "Sites rapides pour les entreprises qui doivent être en ligne rapidement.",
      other_1b: "Voir le service",
      other_2t: "Framework de site business",
      other_2d: "Une structure flexible adaptable à différents types d’entreprises locales.",
      other_2b: "Demander info",
  ...
  home: {
    en: {
      ...
      svc_card_2t: "Business Automation",
      svc_card_2d: "Automate repetitive tasks and simplify your daily operations.",
      svc_card_3t: "Custom Software",
      svc_card_3d: "Tailor-made tools designed specifically for your business needs.",
      svc_card_4t: "Digital Presence",
      svc_card_4d: "Google setup, SEO basics and online visibility for local businesses.",

      proc_title: "Our Process",
      proc_sub: "Simple, clear, and fast—so you know exactly what’s happening.",
      proc_1t: "1) Consultation",
      proc_1d: "We understand your business and your goals.",
      proc_2t: "2) Planning",
      proc_2d: "We propose the simplest solution that works.",
      proc_3t: "3) Build",
      proc_3d: "We develop, test, and keep you updated.",
      proc_4t: "4) Launch",
      proc_4d: "We publish, connect your domain, and support you.",

home_work_tag: "Featured Work",
home_work_title: "RCR Barber Shop",
home_work_text: "A real client project built for a local barbershop brand: premium visual identity, service presentation, booking-ready flow, and trust-focused structure.",
home_work_b1: "Multi-page website with strong branding",
home_work_b2: "Contact, services, hours and booking path",
home_work_b3: "Designed to build trust and convert visits into clients",
home_work_result_t: "Project result",
home_work_result_d: "A more professional online presence that gives the business stronger credibility and a better customer first impression.",
...
home_work_btn2: "Visit website",
    ...
    fr: {
      ...
      svc_card_2d: "Automatisez les tâches répétitives et simplifiez vos opérations quotidiennes.",
      svc_card_3t: "Logiciels sur mesure",
      svc_card_3d: "Outils développés spécifiquement pour les besoins de votre entreprise.",
      svc_card_4t: "Présence numérique",
      svc_card_4d: "Configuration Google, bases SEO et visibilité en ligne pour les entreprises locales.",

      proc_title: "Notre processus",
      proc_sub: "Simple, clair et rapide — pour que vous sachiez toujours ce qui se passe.",
      proc_1t: "1) Consultation",
      proc_1d: "On comprend votre entreprise et vos objectifs.",
      proc_2t: "2) Planification",
      proc_2d: "On propose la solution la plus simple et efficace.",
      proc_3t: "3) Développement",
      proc_3d: "On développe, on teste et on vous tient au courant.",
      proc_4t: "4) Lancement",
      proc_4d: "On publie, on connecte votre domaine et on vous supporte.",

home_work_tag: "Projet en vedette",
home_work_title: "RCR Barber Shop",
home_work_text: "Un vrai projet client réalisé pour une marque de barbershop locale : identité visuelle premium, présentation des services, parcours prêt pour réservation et structure axée sur la confiance.",
home_work_b1: "Site multi-page avec branding fort",
home_work_b2: "Contact, services, horaires et parcours de réservation",
home_work_b3: "Conçu pour inspirer confiance et convertir les visites en clients",
home_work_result_t: "Résultat du projet",
home_work_result_d: "Une présence en ligne plus professionnelle qui donne à l’entreprise plus de crédibilité et une meilleure première impression.",
...
home_work_btn2: "Visiter le site",
  ...
  express: {
    en: {
      exp_tag: "Fast. Professional. Built to launch.",
      exp_h1: "Launch Your Business Website in 72 Hours",
      exp_lead: "Our Launch 72H service helps small businesses go online fast with a clean, modern, mobile-friendly website.",
      exp_cta1: "Start Your Launch",
      exp_cta2: "See Pricing",
      exp_trust: "Perfect for businesses that need to look professional fast.",
    ...
    fr: {
      exp_tag: "Rapide. Professionnel. Prêt à lancer.",
      exp_h1: "Lancez le site web de votre entreprise en 72 heures",
      exp_lead: "Notre service Launch 72H aide les petites entreprises à être en ligne rapidement avec un site moderne, propre et adapté au mobile.",
      exp_cta1: "Démarrer le lancement",
      exp_cta2: "Voir le prix",
      exp_trust: "Parfait pour les entreprises qui doivent paraître professionnelles rapidement.",
  ...
  thankyou: {
    ...
    fr: {
      ...
      ty_p: "Votre message a été reçu. Nous répondons habituellement dans les 24 heures.",
